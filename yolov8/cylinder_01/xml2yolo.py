...
def main():
    ...
    classes = {'cylinder':0}
    xml_path = './Sample/Sample/resized/' # position stored xml
    img_path = './Sample/Sample/resized/' # position stored img
    lbl_path = './Sample/Sample/resized/'
    outfile = './Sample/Sample/train_cylinder.txt'
