...
class camera(QMainWindow): #เป็น class ลูกของ QMainWindow
    def __init__(self):
        ...
        # GPIO.setup(self.box1_pin, GPIO.OUT)
        # GPIO.setup(self.box2_pin, GPIO.OUT)
        # GPIO.output(self.relay_pin, False)
        # GPIO.output(self.box1_pin, False)
        # GPIO.output(self.box2_pin, False)
    ...
    def detection(self,i):
        ...
        if self.full1 == False :
            # GPIO.output(self.box1_pin, False)               # Relay box1 off
            # GPIO.output(self.box2_pin, False)               # Relay box2 off
            ...
            # GPIO.output(self.box1_pin, True)              # full1 ture ---> Relay box1 on
            self.FinalResult_1.setPixmap(QtGui.QPixmap("temp/info/gray.png"))
            self.FinalResult_1.setScaledContents(True)
            ...
            if self.ready1 :
                if self.full2 == False :
                    ...
                    # GPIO.output(self.box2_pin, True)      # full2 ture ---> Relay box2 on
                    ...
                    if self.full2 == True :
                        # GPIO.output(self.relay_pin, True)     #box1 full box2 full ---> relay stopper on
                        # time.sleep(1)
